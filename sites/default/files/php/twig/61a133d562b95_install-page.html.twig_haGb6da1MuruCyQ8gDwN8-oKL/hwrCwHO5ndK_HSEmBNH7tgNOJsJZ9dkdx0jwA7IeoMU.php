...
class __TwigTemplate_15f510f50efa73673e4537f30df3a49849f249ce484a9971534089e5bed338e9 extends \Twig\Template
{
    ...
    ";
        ...
        ";
            ...
            if (($context["site_version"] ?? null)) {
                ...
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["site_version"] ?? null)), "html", null, true));
                echo "</span>
        ";
            }
            // line 21
  ...
  ";
      ...
      ";
            // line 47
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["page"] ?? null), "page_bottom", [])), "html", null, true));
            echo "
    </footer>
  ";
        }
