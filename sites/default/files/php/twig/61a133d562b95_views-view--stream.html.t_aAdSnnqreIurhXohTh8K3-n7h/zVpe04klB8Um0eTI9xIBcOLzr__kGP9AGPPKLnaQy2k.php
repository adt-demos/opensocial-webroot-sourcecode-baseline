...
class __TwigTemplate_193ab139089a860c6b3d77aaa72ee522cee492e8ce3651e17b67c7ecbac80a46 extends \Twig\Template
{
...
<ul";
        // line 36
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => "stream"], "method")), "html", null, true));
        echo ">
  ";
        // line 37
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/views/views-view--stream.html.twig", "/var/www/html/themes/contrib/socialbase/templates/views/views-view--stream.html.twig");
    }
