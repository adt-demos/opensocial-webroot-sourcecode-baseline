...
class __TwigTemplate_f1b991ea1c25c014354b36e825028d8d9c2ca7308d36231bf81ddb57bbe82c0e extends \Twig\Template
{
...
";
        ...
        if ( !twig_test_empty(($context["comment_reply_form_wrapper"] ?? null))) {
            // line 27
            echo "<div ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["comment_reply_form_wrapper"] ?? null)), "html", null, true));
            echo ">
";
        }
        // line 29
...
<div ";
        // line 30
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["comment_wrapper"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method")), "html", null, true));
        echo ">
  <div class=\"comment__avatar\">";
        // line 31
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["current_user_picture"] ?? null)), "html", null, true));
        echo "</div>
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/comment/form--comment.html.twig", "/var/www/html/themes/contrib/socialbase/templates/comment/form--comment.html.twig");
    }
