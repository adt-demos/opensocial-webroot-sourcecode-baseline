...
class __TwigTemplate_68eab897d29182c6f59884ef510cfb7c3a28e9eaad09a9ab38971d50187310ac extends \Twig\Template
{
...
($context["errors"] ?? null)) ? ("panel-danger") : (("panel-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["panel_type"] ?? null))))))];
        // line 26
        echo "<div";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method"), "removeClass", [0 => "form-wrapper"], "method")), "html", null, true));
        echo ">
  ";
        // line 28
        echo "
...
($context["description"] ?? null) && ($this->getAttribute(($context["description"] ?? null), "position", []) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/system/details--plain.html.twig", "/var/www/html/themes/contrib/socialbase/templates/system/details--plain.html.twig");
    }
