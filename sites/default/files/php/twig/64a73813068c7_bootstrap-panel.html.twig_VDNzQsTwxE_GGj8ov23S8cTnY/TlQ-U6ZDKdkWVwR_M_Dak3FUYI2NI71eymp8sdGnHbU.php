...
class __TwigTemplate_2d7c067c8ca678a190e0166d1d0278fc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 84) == "invisible"))) ? ("sr-only") : (""))];
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/card/bootstrap-panel.html.twig", "/var/www/html/themes/contrib/socialbase/templates/card/bootstrap-panel.html.twig");
    }
