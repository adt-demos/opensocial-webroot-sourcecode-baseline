...
class __TwigTemplate_c8e5cc87a472e1c45d372c723d477262c5ecfe87fadd78832e5c5a7a68596aaa extends \Twig\Template
{
...
";
        ...
        if ((($context["name"] ?? null) == "pass")) {
            // line 78
            echo "  ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("socialbase/form--password"), "html", null, true));
            echo "
";
        }
        // line 80
...
<div";
        // line 81
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method"), "removeClass", [0 => "form-inline"], "method")), "html", null, true));
        echo ">
  ";
        // line 82
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/form/form-element.html.twig", "/var/www/html/themes/contrib/socialbase/templates/form/form-element.html.twig");
    }
