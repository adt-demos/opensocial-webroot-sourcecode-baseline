...
/* comment.html.twig */
class __TwigTemplate_a70ce9c18c5318f0b3a5d2381f6bf04272da0c2a95bd08841d7ce519131c4c1f extends \Twig\Template
{
  ...
  <div class=\"comment__content\">
    ...
    ";
        ...
        if (($context["comment_attachments_count"] ?? null)) {
            ...
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["comment_attachments_count"] ?? null)), "html", null, true));
            echo " </div>
    ";
        }
        // line 95
...
";
    ...
    public function block_comment_author($context, array $blocks = [])
    {
      ...
      ";
        ...
        if ((($context["status"] ?? null) == "unpublished")) {
            ...
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t($this->sandbox->ensureToStringAllowed(($context["status"] ?? null)))));
            echo "</span>
      ";
        }
        // line 89
    ...
    {
        return new Source("", "comment.html.twig", "themes/contrib/socialbase/templates/comment/comment.html.twig");
    }
