...
class __TwigTemplate_2467185b426844c846b1022b72f5b31443c153c7252758e80f7422f9e9f86de0 extends \Twig\Template
{
...
";
    ...
    public function block_teaser_image($context, array $blocks = [])
    {
      ...
      ";
        // line 79
        if ( !twig_test_empty(strip_tags($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->renderVar($this->getAttribute(($context["content"] ?? null), (("field_" . $this->getAttribute(($context["node"] ?? null), "bundle", [])) . "_image"), [], "array")), "<img>"))) {
            // line 80
            echo "          ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["content"] ?? null), (("field_" . $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["node"] ?? null), "bundle", []))) . "_image"), [], "array")), "html", null, true));
            echo "
      ";
        } else {
            // line 82
  ...
  ";
    ...
    public function block_extra_text($context, array $blocks = [])
    {
      ...
      ";
        // line 103
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null)), (("field_" . $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["node"] ?? null), "bundle", []))) . "_image")), "html", null, true));
        echo "
    </div>
  ";
    }
