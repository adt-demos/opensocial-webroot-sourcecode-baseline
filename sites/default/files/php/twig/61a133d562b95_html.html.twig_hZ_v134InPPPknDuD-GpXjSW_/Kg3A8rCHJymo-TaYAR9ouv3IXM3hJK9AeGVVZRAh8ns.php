...
class __TwigTemplate_953c381b2c22d87bfe8335b2773257b3992ba2e1326dfc2efc37ab754836184f extends \Twig\Template
{
...
";
    ...
    public function block_svg_icons($context, array $blocks = [])
    {
        // line 62
        echo "      ";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->sandbox->ensureToStringAllowed(($context["svg_icons"] ?? null))));
        echo "
    ";
    }
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/system/html.html.twig", "/var/www/html/themes/contrib/socialbase/templates/system/html.html.twig");
    }
