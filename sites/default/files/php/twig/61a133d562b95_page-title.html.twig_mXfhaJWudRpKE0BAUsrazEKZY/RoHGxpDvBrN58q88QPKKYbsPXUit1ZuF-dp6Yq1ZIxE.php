...
class __TwigTemplate_8a01349181bd20b586595974a75f3538efd9e52a0a815692bab8ae0a134eaec3 extends \Twig\Template
{
...
";
        ...
        if (($context["title"] ?? null)) {
            // line 38
            echo "  <h1";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["title_attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => ($context["extra_classes"] ?? null)], "method")), "html", null, true));
            echo ">";
