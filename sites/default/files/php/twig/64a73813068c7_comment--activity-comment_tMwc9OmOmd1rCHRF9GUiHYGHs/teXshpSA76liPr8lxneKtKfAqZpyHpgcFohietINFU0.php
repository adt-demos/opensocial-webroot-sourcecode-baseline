...
class __TwigTemplate_1b7d3efbb69795d13a2ab1f069ef3234 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_comment_author($context, array $blocks = [])
    {
        ...
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["author"] ?? null), 4, $this->source), "html", null, true);
        echo "
     <span class=\"comment__metadata\">&bullet; ";
        // line 5
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["submitted"] ?? null), 5, $this->source), "html", null, true);
        echo " </span>
   </div>
 ";
    }
