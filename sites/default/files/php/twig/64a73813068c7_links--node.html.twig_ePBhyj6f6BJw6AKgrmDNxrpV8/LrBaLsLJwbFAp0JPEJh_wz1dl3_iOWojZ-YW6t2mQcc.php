...
class __TwigTemplate_d3e8afb9cf294796a996baccb268d80b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["item"], "text_attributes", [], "any", false, false, true, 42)) {
                    // line 43
                    echo "<span";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "text_attributes", [], "any", false, false, true, 43), 43, $this->source), "html", null, true);
                    echo ">";
                    ...
                    // line 45
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "text", [], "any", false, false, true, 45), 45, $this->source), "html", null, true);
                }
            }
    ...
    {
        return array (  63 => 45,  56 => 43,  54 => 42,  50 => 40,  47 => 39,  45 => 38,  41 => 37,  39 => 35,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/contrib/socialbase/templates/node/links--node.html.twig", "/var/www/html/themes/contrib/socialbase/templates/node/links--node.html.twig");
    }
