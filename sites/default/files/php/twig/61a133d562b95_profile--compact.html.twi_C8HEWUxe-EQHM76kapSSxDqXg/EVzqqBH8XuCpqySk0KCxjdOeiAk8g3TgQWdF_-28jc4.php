...
class __TwigTemplate_f9e9b29943fdee82616607411fb81255eb904a7f1cf12b090b005da2b8d99e62 extends \Twig\Template
{
  ...
  <a href=\"";
        ...
        echo "\" title=\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed(($context["profile_name"] ?? null))), "html", null, true));
        echo "\">
    ...
    ";
        ...
        if (($context["profile_image_url"] ?? null)) {
            // line 26
            echo "      <img src=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["profile_image_url"] ?? null)), "html", null, true));
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/profile/profile--compact.html.twig", "/var/www/html/themes/contrib/socialbase/templates/profile/profile--compact.html.twig");
    }
