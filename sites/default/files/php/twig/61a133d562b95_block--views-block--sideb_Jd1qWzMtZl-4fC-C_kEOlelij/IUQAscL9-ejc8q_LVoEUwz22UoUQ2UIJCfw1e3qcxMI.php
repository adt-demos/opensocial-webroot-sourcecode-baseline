...
class __TwigTemplate_473cde28c10e6f511f527db8695986d7d87c6cae0b40665537c949af53f3acb7 extends \Twig\Template
{
...
<section";
        // line 33
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => "card card--list card--views__sidebar"], "method")), "html", null, true));
        echo ">
  <h4 class=\"card__title\">
    ...
    ";
        ...
        ";
            // line 38
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["subtitle"] ?? null)), "html", null, true));
            echo "
    </div>
    ";
        }
  ...
  <footer class=\"card__actionbar\">
    ";
        ...
        if (($context["view_all_path"] ?? null)) {
            // line 45
            echo "    <a href=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["view_all_path"] ?? null)), "html", null, true));
            echo "\" class=\"btn btn-flat\">
      ";
            // line 46
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["button_text"] ?? null)), "html", null, true));
            echo "
    </a>
    ";
        }
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/block/block--views-block--sidebar.html.twig", "/var/www/html/themes/contrib/socialbase/templates/block/block--views-block--sidebar.html.twig");
    }
