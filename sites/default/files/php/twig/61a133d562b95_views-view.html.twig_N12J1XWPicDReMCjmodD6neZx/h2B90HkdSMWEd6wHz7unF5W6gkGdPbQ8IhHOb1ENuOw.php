...
class __TwigTemplate_ca5c9c51a2b8ae3afaa26c796812edf662f2b8635e55dab60d87e99d64952a22 extends \Twig\Template
{
...
<div";
  ...
  ";
    ...
    <div";
            // line 82
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["content_attributes"] ?? null), "addClass", [0 => ($context["error_classes"] ?? null)], "method")), "html", null, true));
            echo "\" role=\"alert\">
      <h4 class=\"sr-only\">";
            // line 83
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Informative message")));
            echo "</h4>
      ";
            // line 84
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/views/views-view.html.twig", "/var/www/html/themes/contrib/socialbase/templates/views/views-view.html.twig");
    }
