...
class __TwigTemplate_47b19083285bc4a3a922a8f1b758617bb0146359f43eaa272d6966e1d2807650 extends \Twig\Template
{
          ...
          ";
            ...
            if (($context["label"] ?? null)) {
                ...
                echo "              <div class=\"card-head\">
                  <header ";
                // line 65
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["title_attributes"] ?? null), "addClass", [0 => "text-center"], "method")), "html", null, true));
                echo ">";
  ...
  ";
      ...
      ";
            ...
            if (($context["label"] ?? null)) {
                // line 81
                echo "          <h2";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["title_attributes"] ?? null), "addClass", [0 => "h4 section-title section-title-stream"], "method")), "html", null, true));
                echo ">";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["label"] ?? null)), "html", null, true));
                echo "</h2>
      ";
...
";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/block/block--views-block--activity-stream-block-stream-homepage.html.twig", "/var/www/html/themes/contrib/socialbase/templates/block/block--views-block--activity-stream-block-stream-homepage.html.twig");
    }
